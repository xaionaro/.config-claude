...
- One source of truth per logic/constant in touched scope — prevents drift, makes changes atomic.
...
- **Correctness over convenience.** Choose the correct, clean solution even when harder. Shortcuts only when explicitly authorized.
