...
- Short tails CAN be the evidence. If the last 1-3 sentences ARE the
  rule-violating utterance (e.g., a one-word question), quote them — that
  is correct, not duplicate.
